  ...
  <div class="shop-header">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isShowSupports=true">
      <div class="discounts-left">
        <div class="activity" :class="activClasses[info.supports[0].type]">
          <span class="content-tag">
    ...
    <div class="activity-sheet" v-show="isShowSupports">
      <div class="activity-sheet-content">
        ...
        优惠活动</h2>
        <ul class="list">
          <li class="activity-item" :class="activClasses[support.type]" v-for="(support, index) in info.supports" :key="index">
            <span class="content-tag">
  ...
  export default {
    data() {
      return {
        ...
        //用来承装优惠的背景颜色
        activClasses: ['activity-green','activity-red','activity-orange']
      }
    },
    computed:{
      ...mapState({
